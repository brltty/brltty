...
typedef enum {
  BAUM_TopKey_Left1  = 001,
  BAUM_TopKey_Left2  = 002,
  BAUM_TopKey_Left3  = 004,
  BAUM_TopKey_Right1 = 010,
  BAUM_TopKey_Right2 = 020,
  BAUM_TopKey_Right3 = 040
} BaumTopKeyCode;
...
#define KEY(key,cmd) case (key): command = (cmd); break;
  if (routingCount == 0) {
    switch (activeKeys.keys) {
      KEY(BAUM_TopKey_Left1, BRL_CMD_TOP);
      KEY(BAUM_TopKey_Left3, BRL_CMD_BOT);
      KEY(BAUM_TopKey_Right1, BRL_CMD_LNUP);
      KEY(BAUM_TopKey_Right3, BRL_CMD_LNDN);
      KEY(BAUM_TopKey_Left2, BRL_CMD_FWINLT);
      KEY(BAUM_TopKey_Right2, BRL_CMD_FWINRT);
    ...
    switch (activeKeys.keys) {
      ...
      KEY(BAUM_TopKey_Left1, BRL_BLK_CUTBEGIN+key);
      KEY(BAUM_TopKey_Left2, BRL_BLK_CUTAPPEND+key);
      KEY(BAUM_TopKey_Left3, BRL_BLK_SETLEFT+key);
      KEY(BAUM_TopKey_Right1, BRL_BLK_CUTLINE+key);
      KEY(BAUM_TopKey_Right2, BRL_BLK_CUTRECT+key);
      KEY(BAUM_TopKey_Right3, BRL_BLK_DESCCHAR+key);
