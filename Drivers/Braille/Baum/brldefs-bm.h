...
#define BM_KEYS_FRONT6 6
#define BM_KEYS_FRONT10 10
...
typedef enum {
  ...
  BM_KEY_FRONT6 = BM_KEY_COMMAND + BM_KEYS_COMMAND,
  BM_KEY_BACK6 = BM_KEY_FRONT6 + BM_KEYS_FRONT6,
  BM_KEY_FRONT10 = BM_KEY_BACK6 + BM_KEYS_FRONT6,
  BM_KEY_BACK10 = BM_KEY_FRONT10 + BM_KEYS_FRONT10,
  BM_KEY_ENTRY = BM_KEY_BACK10 + BM_KEYS_FRONT10,
