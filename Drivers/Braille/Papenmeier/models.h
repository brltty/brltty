...
BEGIN_KEY_NAME_TABLES(2d_s)
  ...
  KEY_NAME_SUBTABLE(status,22),
  KEY_NAME_TABLE(routingKeys1),
END_KEY_NAME_TABLES

BEGIN_KEY_NAME_TABLES(ib_80)
  KEY_NAME_TABLE(front9),
  KEY_NAME_SUBTABLE(status,4),
  KEY_NAME_TABLE(routingKeys1),
END_KEY_NAME_TABLES
...
static const ModelEntry modelTable[] = {
  ...
  { PM_MODEL_IDENTITY(99, trio, "BrailleX Live+ 40", 2),
    PM_CELL_COUNTS(40, 0),
    PM_BAR(0, 0, 1, 1)
  },

  { PM_MODEL_IDENTITY(100, trio, "BrailleX Live 20", 2),
    PM_CELL_COUNTS(20, 0),
    PM_BAR(0, 0, 1, 1)
  }
};
