...
static const int cmdtrans[0100] = {
  ...
  /* 000 (      ) */ 0,
  /* 001 (1     ) */ BRL_CMD_LNUP,
  /* 002 ( 2    ) */ BRL_KEY_CMD(CURSOR_LEFT),
  /* 003 (12    ) */ BRL_KEY_CMD(BACKSPACE),
  /* 004 (  3   ) */ BRL_CMD_CHRLT,
  /* 005 (1 3   ) */ 0 /*k: kbemu*/,
  /* 006 ( 23   ) */ BRL_KEY_CMD(CURSOR_UP),
  ...
  /* 020 (    5 ) */ BRL_KEY_CMD(CURSOR_RIGHT),
  /* 021 (1   5 ) */ 0 /*e: endcmd*/,
  /* 022 ( 2  5 ) */ 0 /*25: prefs*/,
