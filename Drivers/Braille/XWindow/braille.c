...
static struct button buttons_vs[] = {
  ...
  { "^",    BRL_KEY_CMD(CURSOR_UP),    1, 1, 2 },
  { "v",    BRL_KEY_CMD(CURSOR_DOWN),  1, 1, 4 },
  { ">",    BRL_KEY_CMD(CURSOR_RIGHT), 1, 2, 3 },
  { "<",    BRL_KEY_CMD(CURSOR_LEFT),  1, 0, 3 },
  //{ "B3",   BRL_CMD_CSRVIS,     1, 2, 2 },
  { "DEL",  BRL_KEY_CMD(DELETE),       1, 0, 4 },
  { "INS",  BRL_KEY_CMD(INSERT),       1, 2, 4 },
