...
{
  0, BRL_CMD_LNUP, BRL_BLK_PASSKEY+VPK_CURSOR_LEFT, BRL_BLK_PASSKEY+VPK_BACKSPACE, BRL_CMD_CHRLT, 0 /*k: kbemu*/, BRL_BLK_PASSKEY+VPK_CURSOR_UP, BRL_CMD_TOP_LEFT,
  BRL_CMD_LNDN, BRL_CMD_CSRTRK, BRL_CMD_DISPMD, BRL_CMD_FREEZE, BRL_CMD_INFO, BRL_CMD_MUTE, BRL_CMD_NXSEARCH, BRL_CMD_PASTE,
  BRL_BLK_PASSKEY+VPK_CURSOR_RIGHT, 0 /*e: endcmd*/, 0 /*25: prefs*/, BRL_CMD_HOME, 0 /*35: meta*/, 0 /*o: number*/, BRL_CMD_LNBEG, BRL_CMD_RESTARTBRL,
  BRL_CMD_CSRJMP_VERT, BRL_BLK_PASSKEY+VPK_DELETE, BRL_BLK_ROUTE, 0 /*g: internal cursor*/, 0 /*345: blite internal speechbox*/, BRL_CMD_NXPGRPH, BRL_BLK_PASSKEY+VPK_TAB, 0 /*q: finish uppercase*/,
  ...
  BRL_BLK_PASSKEY+VPK_RETURN, 0 /*145: free*/, BRL_BLK_PASSKEY+VPK_ESCAPE, BRL_CMD_PRPGRPH, 0 /*346: free*/, 0 /*x: xtrl*/, BRL_CMD_SIXDOTS, 0 /*12346: free*/,
  BRL_BLK_PASSKEY+VPK_CURSOR_DOWN, BRL_CMD_PRSEARCH, BRL_CMD_LNEND, BRL_CMD_BACK, BRL_BLK_CUTRECT, 0 /*z: abort*/, 0 /*2356: rotate*/, BRL_CMD_NXPROMPT,
