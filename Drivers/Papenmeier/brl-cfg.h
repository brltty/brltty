...
#define CMDS_EASY_X(bar, key, swt, cmd1, cmd2) \
  {cmd1, key, swt|bar}, \
  {cmd2, key, swt|(bar<<4)}
#define CMDS_EASY_U(key, swt, cmd1, cmd2) CMDS_EASY_X(MOD_EASY_BU1, key, swt, cmd1, cmd2)
#define CMDS_EASY_D(key, swt, cmd1, cmd2) CMDS_EASY_X(MOD_EASY_BD1, key, swt, cmd1, cmd2)
#define CMDS_EASY_L(key, swt, cmd1, cmd2) CMDS_EASY_X(MOD_EASY_BL1, key, swt, cmd1, cmd2)
#define CMDS_EASY_R(key, swt, cmd1, cmd2) CMDS_EASY_X(MOD_EASY_BR1, key, swt, cmd1, cmd2)
...
#define CMDS_EASY_C(swt) \
  {CMD_BACK        , NOKEY, MOD_EASY_KLR|swt}, \
  {CMD_HOME        , NOKEY, MOD_EASY_KLF|swt}, \
  {CMD_HELP        , NOKEY, MOD_EASY_KRR|swt}, \
  {CMD_LEARN       , NOKEY, MOD_EASY_KRF|swt}, \
  CMDS_EASY_K(NOKEY,        MOD_EASY_KLR|swt, \
              CMD_SIXDOTS, CMD_PASTE, CMD_CAPBLINK, CMD_CSRJMP_VERT, \
              CMD_DISPMD, CMD_CSRTRK, CMD_ATTRVIS, CMD_CSRVIS), \
  CMDS_EASY_K(NOKEY,        MOD_EASY_KLF|swt, \
              CMD_AUTOSPEAK, CMD_AUTOREPEAT, CMD_RESTARTBRL, CMD_FREEZE, \
              CMD_INFO, CMD_PREFMENU, CMD_PREFLOAD, CMD_PREFSAVE), \
  CMDS_EASY_K(NOKEY,        MOD_EASY_KRR|swt, \
...
#define CMDS_EASY \
  ...
  CMDS_EASY_C(MOD_EASY_SLC|MOD_EASY_SRC), \
  CMDS_EASY_C(MOD_EASY_SLC|MOD_EASY_SRR), \
  CMDS_EASY_C(MOD_EASY_SLC|MOD_EASY_SRF), \
  CMDS_EASY_C(MOD_EASY_SLR|MOD_EASY_SRC), \
  CMDS_EASY_C(MOD_EASY_SLR|MOD_EASY_SRR), \
  CMDS_EASY_C(MOD_EASY_SLR|MOD_EASY_SRF), \
  CMDS_EASY_C(MOD_EASY_SLF|MOD_EASY_SRC), \
  CMDS_EASY_C(MOD_EASY_SLF|MOD_EASY_SRR), \
  CMDS_EASY_C(MOD_EASY_SLF|MOD_EASY_SRF)
...
#define CMDS_EASY_SWSIM \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLC|MOD_EASY_SRC), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLC|MOD_EASY_SRR), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLC|MOD_EASY_SRF), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLR|MOD_EASY_SRC), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLR|MOD_EASY_SRR), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLR|MOD_EASY_SRF), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLF|MOD_EASY_SRC), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLF|MOD_EASY_SRR), \
  CMDS_EASY_SWSIM_SWT(MOD_EASY_SLF|MOD_EASY_SRF)
