 ...
 */
  ...
  /* movement */
    ...
    KEY (KEY_CROUND, (cmds == CMDS_PREFS) ? CMD_MENU_PREV_SETTING
	 : CMD_CSRTRK);
  ...
  /* keyboard cursor keys simulation */
    ...
    KEY (KEY_CUP, (cmds == CMDS_PREFS && displayType == PB40)
	 ? CMD_MENU_PREV_SETTING : VAL_PASSKEY+VPK_CURSOR_UP);
    KEY (KEY_CDOWN, (cmds == CMDS_PREFS && displayType == PB40)
	 ? CMD_MENU_NEXT_SETTING : VAL_PASSKEY+VPK_CURSOR_DOWN);
