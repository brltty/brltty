...
GRADLE_DEBUG_PACKAGE = $(GRADLE_PACKAGE_DIRECTORY)/$(GRADLE_DEBUG_VARIANT)/$(GRADLE_APP_NAME)-universal-$(GRADLE_DEBUG_VARIANT).$(GRADLE_PACKAGE_EXTENSION)
GRADLE_RELEASE_PACKAGE = $(GRADLE_PACKAGE_DIRECTORY)/$(GRADLE_RELEASE_VARIANT)/$(GRADLE_APP_NAME)-universal-$(GRADLE_RELEASE_VARIANT).$(GRADLE_PACKAGE_EXTENSION)
