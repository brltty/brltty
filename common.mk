...
INSTALL_KEYBOARD_KEY_TABLES_DIRECTORY = $(INSTALL_TABLES_DIRECTORY)/$(KEYBOARD_KEY_TABLE_SUBDIRECTORY)
install-keyboard-key-tables-directory:
	$(INSTALL_DIRECTORY) $(INSTALL_KEYBOARD_KEY_TABLES_DIRECTORY)

INSTALL_BRAILLE_KEY_TABLES_DIRECTORY = $(INSTALL_TABLES_DIRECTORY)/$(BRAILLE_KEY_TABLE_SUBDIRECTORY)
install-braille-key-tables-directory:
	$(INSTALL_DIRECTORY) $(INSTALL_BRAILLE_KEY_TABLES_DIRECTORY)
...
INSTALL_GDM_AUTOSTART_DIRECTORY = $(INSTALL_ROOT)$(GDM_AUTOSTART_DIRECTORY)
