...
BEGIN_KEY_CODE_MAP
  [ANDROID_KEY_0] = KBD_KEY_DIGIT(Zero),
  [ANDROID_KEY_1] = KBD_KEY_DIGIT(One),
  [ANDROID_KEY_2] = KBD_KEY_DIGIT(Two),
  [ANDROID_KEY_3] = KBD_KEY_DIGIT(Three),
  [ANDROID_KEY_3D_MODE] = KBD_KEY_UNMAPPED,
  [ANDROID_KEY_4] = KBD_KEY_DIGIT(Four),
  [ANDROID_KEY_5] = KBD_KEY_DIGIT(Five),
  [ANDROID_KEY_6] = KBD_KEY_DIGIT(Six),
  [ANDROID_KEY_7] = KBD_KEY_DIGIT(Seven),
  [ANDROID_KEY_8] = KBD_KEY_DIGIT(Eight),
  [ANDROID_KEY_9] = KBD_KEY_DIGIT(Nine),
