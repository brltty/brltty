...
static int
writeCharacter_native (FILE *file, wchar_t character, unsigned char dots, const unsigned char *byte, int isPrimary, const void *data) {
...
static int
writeTable_native (const char *path, FILE *file, TextTableData *ttd, const void *data) {
...
static int
writeTable_binary (const char *path, FILE *file, TextTableData *ttd, const void *data) {
  int byte;
...
static int
writeCharacter_gnome (FILE *file, wchar_t character, unsigned char dots, const unsigned char *byte, int isPrimary, const void *data) {
...
static int
writeTable_gnome (const char *path, FILE *file, TextTableData *ttd, const void *data) {
...
static int
writeCharacter_libLouis (FILE *file, wchar_t character, unsigned char dots, const unsigned char *byte, int isPrimary, const void *data) {
  {
    const char *type;
...
static int
writeTable_libLouis (const char *path, FILE *file, TextTableData *ttd, const void *data) {
  if (fprintf(file, "# generated by %s\n", programName) == EOF) goto error;
...
static int
writeCharacter_XCompose (FILE *file, wchar_t character, unsigned char dots, const unsigned char *byte, int isPrimary, const void *_data) {
  if (isPrimary) {
...
static int
writeTable_XCompose (const char *path, FILE *file, TextTableData *ttd, const void *data) {
  if (fprintf(file, "# generated by %s\n", programName) == EOF) goto error;
...
static int
writeCharacter_JAWS (FILE *file, wchar_t character, unsigned char dots, const unsigned char *byte, int isPrimary, const void *data) {
...
static int
writeTable_JAWS (const char *path, FILE *file, TextTableData *ttd, const void *data) {
  if (fprintf(file, "; generated by %s\n", programName) != EOF) {
