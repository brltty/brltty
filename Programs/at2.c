...
static const At2KeyTable at2KeysOriginal = {
  [0X76] = {BRL_BLK_PASSKEY+VPK_ESCAPE},
  [0X05] = {BRL_BLK_PASSKEY+VPK_FUNCTION+0},
  [0X06] = {BRL_BLK_PASSKEY+VPK_FUNCTION+1},
  [0X04] = {BRL_BLK_PASSKEY+VPK_FUNCTION+2},
  [0X0C] = {BRL_BLK_PASSKEY+VPK_FUNCTION+3},
  [0X03] = {BRL_BLK_PASSKEY+VPK_FUNCTION+4},
  [0X0B] = {BRL_BLK_PASSKEY+VPK_FUNCTION+5},
  [0X83] = {BRL_BLK_PASSKEY+VPK_FUNCTION+6},
  [0X0A] = {BRL_BLK_PASSKEY+VPK_FUNCTION+7},
  [0X01] = {BRL_BLK_PASSKEY+VPK_FUNCTION+8},
  [0X09] = {BRL_BLK_PASSKEY+VPK_FUNCTION+9},
  [0X78] = {BRL_BLK_PASSKEY+VPK_FUNCTION+10},
  [0X07] = {BRL_BLK_PASSKEY+VPK_FUNCTION+11},
  ...
  [0X66] = {BRL_BLK_PASSKEY+VPK_BACKSPACE},

  [0X0D] = {BRL_BLK_PASSKEY+VPK_TAB},
  ...
  [0X5A] = {BRL_BLK_PASSKEY+VPK_RETURN},
  ...
  [0X6C] = {BRL_BLK_PASSKEY+VPK_HOME, BRL_BLK_PASSCHAR+'7'},
  [0X75] = {BRL_BLK_PASSKEY+VPK_CURSOR_UP, BRL_BLK_PASSCHAR+'8'},
  [0X7D] = {BRL_BLK_PASSKEY+VPK_PAGE_UP, BRL_BLK_PASSCHAR+'9'},

  [0X6B] = {BRL_BLK_PASSKEY+VPK_CURSOR_LEFT, BRL_BLK_PASSCHAR+'4'},
  [0X73] = {BRL_BLK_PASSCHAR+'5'},
  [0X74] = {BRL_BLK_PASSKEY+VPK_CURSOR_RIGHT, BRL_BLK_PASSCHAR+'6'},

  [0X69] = {BRL_BLK_PASSKEY+VPK_END, BRL_BLK_PASSCHAR+'1'},
  [0X72] = {BRL_BLK_PASSKEY+VPK_CURSOR_DOWN, BRL_BLK_PASSCHAR+'2'},
  [0X7A] = {BRL_BLK_PASSKEY+VPK_PAGE_DOWN, BRL_BLK_PASSCHAR+'3'},

  [0X70] = {BRL_BLK_PASSKEY+VPK_INSERT, BRL_BLK_PASSCHAR+'0'},
  [0X71] = {BRL_BLK_PASSKEY+VPK_DELETE, BRL_BLK_PASSCHAR+'.'}
};
...
static const At2KeyTable at2KeysE0 = {
  ...
  [0X70] = {BRL_BLK_PASSKEY+VPK_INSERT},
  [0X71] = {BRL_BLK_PASSKEY+VPK_DELETE},
  [0X6C] = {BRL_BLK_PASSKEY+VPK_HOME},
  [0X69] = {BRL_BLK_PASSKEY+VPK_END},
  [0X7D] = {BRL_BLK_PASSKEY+VPK_PAGE_UP},
  [0X7A] = {BRL_BLK_PASSKEY+VPK_PAGE_DOWN},
  [0X75] = {BRL_BLK_PASSKEY+VPK_CURSOR_UP},
  [0X6B] = {BRL_BLK_PASSKEY+VPK_CURSOR_LEFT},
  [0X72] = {BRL_BLK_PASSKEY+VPK_CURSOR_DOWN},
  [0X74] = {BRL_BLK_PASSKEY+VPK_CURSOR_RIGHT},
        ...
        if (!release) {
          ...
          if ((blk == BRL_BLK_PASSKEY) && AT2_TST(AT2_LEFT_ALT)) {
            ...
            switch (arg) {
              ...
              default:
                if (arg >= VPK_FUNCTION) {
                  cmd = BRL_BLK_SWITCHVT + (arg - VPK_FUNCTION);
                }
                break;
            }
          }
