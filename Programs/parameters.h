...
#define GIO_USB_INPUT_DISABLE_MONITORING 1
#define GIO_USB_INPUT_MONITOR_TIMEOUT 200

#define SERIAL_DEVICE_RESTART_DELAY 500

#define USB_INPUT_RETRY_INTERVAL_MINIMUM 20

#define BLUETOOTH_DEVICE_NAME_TIMEOUT 5000
...
#define LINUX_USB_INPUT_TREAT_INTERRUPT_AS_BULK 1
