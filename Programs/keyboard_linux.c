...
BEGIN_KEY_CODE_MAP
  ...
  [KEY_1] = KBD_KEY_DIGIT(One),
  [KEY_2] = KBD_KEY_DIGIT(Two),
  [KEY_3] = KBD_KEY_DIGIT(Three),
  [KEY_4] = KBD_KEY_DIGIT(Four),
  [KEY_5] = KBD_KEY_DIGIT(Five),
  [KEY_6] = KBD_KEY_DIGIT(Six),
  [KEY_7] = KBD_KEY_DIGIT(Seven),
  [KEY_8] = KBD_KEY_DIGIT(Eight),
  [KEY_9] = KBD_KEY_DIGIT(Nine),
  [KEY_0] = KBD_KEY_DIGIT(Zero),
  ...
  [KEY_LEFTCTRL] = KBD_KEY_ACTION(ControlLeft),
  ...
  [KEY_LEFTSHIFT] = KBD_KEY_ACTION(ShiftLeft),
  ...
  [KEY_RIGHTSHIFT] = KBD_KEY_ACTION(ShiftRight),
  [KEY_KPASTERISK] = KBD_KEY_KEYPAD(Asterisk),
  [KEY_LEFTALT] = KBD_KEY_ACTION(AltLeft),
  [KEY_SPACE] = KBD_KEY_ACTION(Space),
  ...
  [KEY_RIGHTCTRL] = KBD_KEY_ACTION(ControlRight),
  [KEY_KPSLASH] = KBD_KEY_KEYPAD(Slash),
  [KEY_SYSRQ] = KBD_KEY_ACTION(SystemRequest),
  [KEY_RIGHTALT] = KBD_KEY_ACTION(AltRight),
