...
typedef enum {
  ...
  AT_KEY_00_J                 = 0X3B,
  AT_KEY_00_U                 = 0X3C,
  AT_KEY_00_Seven             = 0X3D,
  AT_KEY_00_Eight             = 0X3E,
  AT_KEY_00_F20               = 0X40,
  ...
  AT_KEY_00_KeypadOne         = 0X69,
  AT_KEY_00_International3    = 0X6A,
  AT_KEY_00_KeypadFour        = 0X6B,
  AT_KEY_00_KeypadSeven       = 0X6C,
  AT_KEY_00_KeypadComma       = 0X6D,
  AT_KEY_00_KeypadZero        = 0X70,
  AT_KEY_00_KeypadPeriod      = 0X71,
  AT_KEY_00_KeypadTwo         = 0X72,
  AT_KEY_00_KeypadFive        = 0X73,
  AT_KEY_00_KeypadSix         = 0X74,
  AT_KEY_00_KeypadEight       = 0X75,
  AT_KEY_00_Escape            = 0X76,
  AT_KEY_00_NumLock           = 0X77,
  AT_KEY_00_F11               = 0X78,
  AT_KEY_00_KeypadPlus        = 0X79,
  AT_KEY_00_KeypadThree       = 0X7A,
  AT_KEY_00_KeypadMinus       = 0X7B,
  AT_KEY_00_KeypadTimes       = 0X7C,
  AT_KEY_00_KeypadNine        = 0X7D,
...
typedef enum {
  ...
  AT_KEY_E0_KeypadDivide      = 0X4A,
  AT_KEY_E0_KeypadEnter       = 0X5A,
  AT_KEY_E0_End               = 0X69,
...
typedef enum {
  ...
  XT_KEY_00_One               = 0X02,
  XT_KEY_00_Two               = 0X03,
  XT_KEY_00_Three             = 0X04,
  XT_KEY_00_Four              = 0X05,
  XT_KEY_00_Five              = 0X06,
  XT_KEY_00_Six               = 0X07,
  XT_KEY_00_Seven             = 0X08,
  XT_KEY_00_Eight             = 0X09,
  XT_KEY_00_Nine              = 0X0A,
  XT_KEY_00_Zero              = 0X0B,
  XT_KEY_00_Minus             = 0X0C,
  XT_KEY_00_Equals            = 0X0D,
  ...
  XT_KEY_00_KeypadSeven       = 0X47,
  XT_KEY_00_KeypadEight       = 0X48,
  XT_KEY_00_KeypadNine        = 0X49,
  XT_KEY_00_KeypadMinus       = 0X4A,
  XT_KEY_00_KeypadFour        = 0X4B,
  XT_KEY_00_KeypadFive        = 0X4C,
  XT_KEY_00_KeypadSix         = 0X4D,
  XT_KEY_00_KeypadPlus        = 0X4E,
  XT_KEY_00_KeypadOne         = 0X4F,
  XT_KEY_00_KeypadTwo         = 0X50,
  XT_KEY_00_KeypadThree       = 0X51,
  XT_KEY_00_KeypadZero        = 0X52,
  XT_KEY_00_KeypadPeriod      = 0X53,
  XT_KEY_00_Europe2           = 0X56,
  XT_KEY_00_F11               = 0X57,
  XT_KEY_00_F12               = 0X58,
  XT_KEY_00_KeypadEquals      = 0X59,
  ...
  XT_KEY_00_KeypadComma       = 0X7E,
  XT_KEY_00_Language2         = 0XF1,
  XT_KEY_00_Language1         = 0XF2,
} XtKey00;

typedef enum {
  XT_KEY_E0_KeypadEnter       = 0X1C,
  XT_KEY_E0_RightControl      = 0X1D,
  XT_KEY_E0_KeypadDivide      = 0X35,
...
typedef enum {
  ...
  HID_KEY_KeypadDivide      = 0X54,
  HID_KEY_KeypadTimes       = 0X55,
  HID_KEY_KeypadMinus       = 0X56,
  HID_KEY_KeypadPlus        = 0X57,
  HID_KEY_KeypadEnter       = 0X58,
  HID_KEY_KeypadOne         = 0X59,
  HID_KEY_KeypadTwo         = 0X5A,
  HID_KEY_KeypadThree       = 0X5B,
  HID_KEY_KeypadFour        = 0X5C,
  HID_KEY_KeypadFive        = 0X5D,
  HID_KEY_KeypadSix         = 0X5E,
  HID_KEY_KeypadSeven       = 0X5F,
  HID_KEY_KeypadEight       = 0X60,
  HID_KEY_KeypadNine        = 0X61,
  HID_KEY_KeypadZero        = 0X62,
  HID_KEY_KeypadPeriod      = 0X63,
  HID_KEY_Europe2           = 0X64,
  HID_KEY_App               = 0X65,
  HID_KEY_Power             = 0X66,
  HID_KEY_KeypadEquals      = 0X67,
  HID_KEY_F13               = 0X68,
  HID_KEY_F14               = 0X69,
  HID_KEY_F15               = 0X6A,
  HID_KEY_F16               = 0X6B,
  ...
  HID_KEY_CapsLockXXX       = 0X82,
  HID_KEY_NumLockXXX        = 0X83,
  HID_KEY_ScrollLockXXX     = 0X84,
  HID_KEY_KeypadComma       = 0X85,
  HID_KEY_EqualsXXX         = 0X86,
  HID_KEY_International1    = 0X87,
  HID_KEY_International2    = 0X88,
  HID_KEY_International3    = 0X89,
  HID_KEY_International4    = 0X8A,
  HID_KEY_International5    = 0X8B,
  HID_KEY_International6    = 0X8C,
  HID_KEY_International7    = 0X8D,
  HID_KEY_International8    = 0X8E,
  HID_KEY_International9    = 0X8F,
  HID_KEY_Language1         = 0X90,
  HID_KEY_Language2         = 0X91,
  HID_KEY_Language3         = 0X92,
  HID_KEY_Language4         = 0X93,
  HID_KEY_Language5         = 0X94,
  ...
  HID_KEY_Clear             = 0X9C,
  HID_KEY_Prior             = 0X9D,
  HID_KEY_ReturnXXX         = 0X9E,
  HID_KEY_Separator         = 0X9F,
  HID_KEY_Out               = 0XA0,
  HID_KEY_Oper              = 0XA1,
  HID_KEY_ClearXXX          = 0XA2,
  HID_KEY_CrSel             = 0XA3,
  HID_KEY_ExSel             = 0XA4,
