...
typedef enum {
  AT_KEY_E0_WWWSearch         = 0X10,
  AT_KEY_E0_RightAlt          = 0X11,
  AT_KEY_E0_RightControl      = 0X14,
  AT_KEY_E0_PreviousTrack     = 0X15,
  AT_KEY_E0_WWWFavorites      = 0X18,
  AT_KEY_E0_LeftGUI           = 0X1F,
  AT_KEY_E0_WWWRefresh        = 0X20,
  AT_KEY_E0_VolumeDown        = 0X21,
  AT_KEY_E0_Mute              = 0X23,
  AT_KEY_E0_RightGUI          = 0X27,
  AT_KEY_E0_WWWStop           = 0X28,
  AT_KEY_E0_Calculator        = 0X2B,
  AT_KEY_E0_App               = 0X2F,
  AT_KEY_E0_WWWForward        = 0X30,
  AT_KEY_E0_VolumeUp          = 0X32,
  AT_KEY_E0_PlayPause         = 0X34,
  AT_KEY_E0_Power             = 0X37,
  AT_KEY_E0_WWWBack           = 0X38,
  AT_KEY_E0_WWWHome           = 0X3A,
  AT_KEY_E0_Stop              = 0X3B,
  AT_KEY_E0_Sleep             = 0X3F,
  AT_KEY_E0_MyComputer        = 0X40,
  AT_KEY_E0_Mail              = 0X48,
  AT_KEY_E0_KPDivide          = 0X4A,
  AT_KEY_E0_NextTrack         = 0X4D,
  AT_KEY_E0_MediaSelect       = 0X50,
...
typedef enum {
  ...
  HID_KEY_KPDivide             = 0X54,
  HID_KEY_KPTimes              = 0X55,
  ...
  HID_KEY_CapsLockXXX          = 0X82, // locking capitals
  HID_KEY_NumLockXXX           = 0X83, // locking numbers
  HID_KEY_ScrollLockXXX        = 0X84, // locking scroll
  HID_KEY_KPComma              = 0X85,
  HID_KEY_EqualXXX             = 0X86,
  ...
  HID_KEY_Out                  = 0XA0,
  HID_KEY_Oper                 = 0XA1,
  HID_KEY_ClearXXX             = 0XA2, // clear_again
  HID_KEY_CrSel                = 0XA3,
  HID_KEY_ExSel                = 0XA4,
  HID_KEY_KP00                 = 0XB0,
  HID_KEY_KP000                = 0XB1,
