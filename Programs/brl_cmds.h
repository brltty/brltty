...
typedef enum {
  ...
  BRL_BLK_SET_TTB /* set text table */,
  BRL_BLK_SET_ATB /* set attributes table */,
  BRL_BLK_SET_CTB /* set contraction table */,
  BRL_BLK_SET_KTB /* set keyboard table */,
  BRL_BLK_SET_LPF /* set language profile */,
  BRL_BLK_17 /* (reserved) */,
  BRL_BLK_18 /* (reserved) */,
  BRL_BLK_19 /* (reserved) */,
  BRL_BLK_1A /* (reserved) */,
