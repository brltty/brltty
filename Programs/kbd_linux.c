...
BEGIN_KEY_CODE_MAP
  ...
  [KEY_CLOSECD] = KBD_KEY_UNMAPPED,
  [KEY_EJECTCD] = KBD_KEY_UNMAPPED,
  [KEY_EJECTCLOSECD] = KBD_KEY_UNMAPPED,
  [KEY_NEXTSONG] = KBD_KEY_FUNCTION(SongNext),
  [KEY_PLAYPAUSE] = KBD_KEY_FUNCTION(PlayPause),
  [KEY_PREVIOUSSONG] = KBD_KEY_FUNCTION(SongPrevious),
  [KEY_STOPCD] = KBD_KEY_UNMAPPED,
  [KEY_RECORD] = KBD_KEY_UNMAPPED,
  [KEY_REWIND] = KBD_KEY_UNMAPPED,
  ...
  [KEY_PLAYCD] = KBD_KEY_UNMAPPED,
  [KEY_PAUSECD] = KBD_KEY_UNMAPPED,
  ...
  [KEY_FASTFORWARD] = KBD_KEY_UNMAPPED,
