...
BEGIN_KEY_CODE_MAP
  ...
  [KEY_ZENKAKUHANKAKU] = KBD_KEY_UNKNOWN,
  [KEY_102ND] = KBD_KEY_UNKNOWN,
  [KEY_F11] = KBD_KEY_FUNCTION(F11),
  [KEY_F12] = KBD_KEY_FUNCTION(F12),
  [KEY_RO] = KBD_KEY_UNKNOWN,
  [KEY_KATAKANA] = KBD_KEY_UNKNOWN,
  [KEY_HIRAGANA] = KBD_KEY_UNKNOWN,
  [KEY_HENKAN] = KBD_KEY_UNKNOWN,
  [KEY_KATAKANAHIRAGANA] = KBD_KEY_UNKNOWN,
  [KEY_MUHENKAN] = KBD_KEY_UNKNOWN,
  [KEY_KPJPCOMMA] = KBD_KEY_UNKNOWN,
  ...
  [KEY_MACRO] = KBD_KEY_UNKNOWN,
  [KEY_MUTE] = KBD_KEY_FUNCTION(Mute),
  [KEY_VOLUMEDOWN] = KBD_KEY_FUNCTION(VolumeDown),
  [KEY_VOLUMEUP] = KBD_KEY_FUNCTION(VolumeUp),
  ...
  [KEY_HANGEUL] = KBD_KEY_UNKNOWN,
  [KEY_HANGUEL] = KBD_KEY_UNKNOWN,
  [KEY_HANJA] = KBD_KEY_UNKNOWN,
  [KEY_YEN] = KBD_KEY_UNKNOWN,
  [KEY_LEFTMETA] = KBD_KEY_UNKNOWN,
  [KEY_RIGHTMETA] = KBD_KEY_UNKNOWN,
  [KEY_COMPOSE] = KBD_KEY_UNKNOWN,
  [KEY_STOP] = KBD_KEY_FUNCTION(Stop),
  [KEY_AGAIN] = KBD_KEY_FUNCTION(Again),
  [KEY_PROPS] = KBD_KEY_UNKNOWN,
  [KEY_UNDO] = KBD_KEY_FUNCTION(Undo),
  [KEY_FRONT] = KBD_KEY_UNKNOWN,
  [KEY_COPY] = KBD_KEY_FUNCTION(Copy),
  [KEY_OPEN] = KBD_KEY_FUNCTION(Execute),
  ...
  [KEY_CALC] = KBD_KEY_UNKNOWN,
  [KEY_SETUP] = KBD_KEY_UNKNOWN,
  [KEY_SLEEP] = KBD_KEY_UNKNOWN,
  [KEY_WAKEUP] = KBD_KEY_UNKNOWN,
  [KEY_FILE] = KBD_KEY_UNKNOWN,
  [KEY_SENDFILE] = KBD_KEY_UNKNOWN,
  [KEY_DELETEFILE] = KBD_KEY_UNKNOWN,
  [KEY_XFER] = KBD_KEY_UNKNOWN,
  [KEY_PROG1] = KBD_KEY_UNKNOWN,
  [KEY_PROG2] = KBD_KEY_UNKNOWN,
  [KEY_WWW] = KBD_KEY_UNKNOWN,
  [KEY_MSDOS] = KBD_KEY_UNKNOWN,
  [KEY_COFFEE] = KBD_KEY_UNKNOWN,
  [KEY_SCREENLOCK] = KBD_KEY_UNKNOWN,
  [KEY_DIRECTION] = KBD_KEY_UNKNOWN,
  [KEY_CYCLEWINDOWS] = KBD_KEY_UNKNOWN,
  [KEY_MAIL] = KBD_KEY_UNKNOWN,
  [KEY_BOOKMARKS] = KBD_KEY_UNKNOWN,
  [KEY_COMPUTER] = KBD_KEY_UNKNOWN,
  [KEY_BACK] = KBD_KEY_UNKNOWN,
  [KEY_FORWARD] = KBD_KEY_UNKNOWN,
  [KEY_CLOSECD] = KBD_KEY_UNKNOWN,
  [KEY_EJECTCD] = KBD_KEY_UNKNOWN,
  [KEY_EJECTCLOSECD] = KBD_KEY_UNKNOWN,
  [KEY_NEXTSONG] = KBD_KEY_UNKNOWN,
  [KEY_PLAYPAUSE] = KBD_KEY_UNKNOWN,
  [KEY_PREVIOUSSONG] = KBD_KEY_UNKNOWN,
  [KEY_STOPCD] = KBD_KEY_UNKNOWN,
  [KEY_RECORD] = KBD_KEY_UNKNOWN,
  [KEY_REWIND] = KBD_KEY_UNKNOWN,
  [KEY_PHONE] = KBD_KEY_UNKNOWN,
  [KEY_ISO] = KBD_KEY_UNKNOWN,
  [KEY_CONFIG] = KBD_KEY_UNKNOWN,
  [KEY_HOMEPAGE] = KBD_KEY_UNKNOWN,
  [KEY_REFRESH] = KBD_KEY_UNKNOWN,
  [KEY_EXIT] = KBD_KEY_UNKNOWN,
  [KEY_MOVE] = KBD_KEY_UNKNOWN,
  [KEY_EDIT] = KBD_KEY_UNKNOWN,
  [KEY_SCROLLUP] = KBD_KEY_UNKNOWN,
  [KEY_SCROLLDOWN] = KBD_KEY_UNKNOWN,
  [KEY_KPLEFTPAREN] = KBD_KEY_KEYPAD(LeftParenthesis),
  [KEY_KPRIGHTPAREN] = KBD_KEY_KEYPAD(RightParenthesis),
  [KEY_NEW] = KBD_KEY_UNKNOWN,
  [KEY_REDO] = KBD_KEY_UNKNOWN,
  ...
  [KEY_PLAYCD] = KBD_KEY_UNKNOWN,
  [KEY_PAUSECD] = KBD_KEY_UNKNOWN,
  [KEY_PROG3] = KBD_KEY_UNKNOWN,
  [KEY_PROG4] = KBD_KEY_UNKNOWN,
  [KEY_SUSPEND] = KBD_KEY_UNKNOWN,
  [KEY_CLOSE] = KBD_KEY_UNKNOWN,
  [KEY_PLAY] = KBD_KEY_UNKNOWN,
  [KEY_FASTFORWARD] = KBD_KEY_UNKNOWN,
  [KEY_BASSBOOST] = KBD_KEY_UNKNOWN,
  [KEY_PRINT] = KBD_KEY_UNKNOWN,
  [KEY_HP] = KBD_KEY_UNKNOWN,
  [KEY_CAMERA] = KBD_KEY_UNKNOWN,
  [KEY_SOUND] = KBD_KEY_UNKNOWN,
  [KEY_QUESTION] = KBD_KEY_UNKNOWN,
  [KEY_EMAIL] = KBD_KEY_UNKNOWN,
  [KEY_CHAT] = KBD_KEY_UNKNOWN,
  [KEY_SEARCH] = KBD_KEY_UNKNOWN,
  [KEY_CONNECT] = KBD_KEY_UNKNOWN,
  [KEY_FINANCE] = KBD_KEY_UNKNOWN,
  [KEY_SPORT] = KBD_KEY_UNKNOWN,
  [KEY_SHOP] = KBD_KEY_UNKNOWN,
  [KEY_ALTERASE] = KBD_KEY_UNKNOWN,
  [KEY_CANCEL] = KBD_KEY_UNKNOWN,
  [KEY_BRIGHTNESSDOWN] = KBD_KEY_UNKNOWN,
  [KEY_BRIGHTNESSUP] = KBD_KEY_UNKNOWN,
  [KEY_MEDIA] = KBD_KEY_UNKNOWN,
  [KEY_SWITCHVIDEOMODE] = KBD_KEY_UNKNOWN,
  [KEY_KBDILLUMTOGGLE] = KBD_KEY_UNKNOWN,
  [KEY_KBDILLUMDOWN] = KBD_KEY_UNKNOWN,
  [KEY_KBDILLUMUP] = KBD_KEY_UNKNOWN,
  [KEY_SEND] = KBD_KEY_UNKNOWN,
  [KEY_REPLY] = KBD_KEY_UNKNOWN,
  [KEY_FORWARDMAIL] = KBD_KEY_UNKNOWN,
  [KEY_SAVE] = KBD_KEY_UNKNOWN,
  [KEY_DOCUMENTS] = KBD_KEY_UNKNOWN,
  [KEY_BATTERY] = KBD_KEY_UNKNOWN,
  [KEY_BLUETOOTH] = KBD_KEY_UNKNOWN,
  [KEY_WLAN] = KBD_KEY_UNKNOWN,
  [KEY_UWB] = KBD_KEY_UNKNOWN,
  [KEY_UNKNOWN] = KBD_KEY_UNKNOWN,
  [KEY_VIDEO_NEXT] = KBD_KEY_UNKNOWN,
  [KEY_VIDEO_PREV] = KBD_KEY_UNKNOWN,
  [KEY_BRIGHTNESS_CYCLE] = KBD_KEY_UNKNOWN,
  [KEY_BRIGHTNESS_ZERO] = KBD_KEY_UNKNOWN,
  [KEY_DISPLAY_OFF] = KBD_KEY_UNKNOWN,
  [KEY_WIMAX] = KBD_KEY_UNKNOWN,
  [BTN_MISC] = KBD_KEY_UNKNOWN,
  [BTN_0] = KBD_KEY_UNKNOWN,
  [BTN_1] = KBD_KEY_UNKNOWN,
  [BTN_2] = KBD_KEY_UNKNOWN,
  [BTN_3] = KBD_KEY_UNKNOWN,
  [BTN_4] = KBD_KEY_UNKNOWN,
  [BTN_5] = KBD_KEY_UNKNOWN,
  [BTN_6] = KBD_KEY_UNKNOWN,
  [BTN_7] = KBD_KEY_UNKNOWN,
  [BTN_8] = KBD_KEY_UNKNOWN,
  [BTN_9] = KBD_KEY_UNKNOWN,
  [BTN_MOUSE] = KBD_KEY_UNKNOWN,
  [BTN_LEFT] = KBD_KEY_UNKNOWN,
  [BTN_RIGHT] = KBD_KEY_UNKNOWN,
  [BTN_MIDDLE] = KBD_KEY_UNKNOWN,
  [BTN_SIDE] = KBD_KEY_UNKNOWN,
  [BTN_EXTRA] = KBD_KEY_UNKNOWN,
  [BTN_FORWARD] = KBD_KEY_UNKNOWN,
  [BTN_BACK] = KBD_KEY_UNKNOWN,
  [BTN_TASK] = KBD_KEY_UNKNOWN,
  [BTN_JOYSTICK] = KBD_KEY_UNKNOWN,
  [BTN_TRIGGER] = KBD_KEY_UNKNOWN,
  [BTN_THUMB] = KBD_KEY_UNKNOWN,
  [BTN_THUMB2] = KBD_KEY_UNKNOWN,
  [BTN_TOP] = KBD_KEY_UNKNOWN,
  [BTN_TOP2] = KBD_KEY_UNKNOWN,
  [BTN_PINKIE] = KBD_KEY_UNKNOWN,
  [BTN_BASE] = KBD_KEY_UNKNOWN,
  [BTN_BASE2] = KBD_KEY_UNKNOWN,
  [BTN_BASE3] = KBD_KEY_UNKNOWN,
  [BTN_BASE4] = KBD_KEY_UNKNOWN,
  [BTN_BASE5] = KBD_KEY_UNKNOWN,
  [BTN_BASE6] = KBD_KEY_UNKNOWN,
  [BTN_DEAD] = KBD_KEY_UNKNOWN,
  [BTN_GAMEPAD] = KBD_KEY_UNKNOWN,
  [BTN_A] = KBD_KEY_UNKNOWN,
  [BTN_B] = KBD_KEY_UNKNOWN,
  [BTN_C] = KBD_KEY_UNKNOWN,
  [BTN_X] = KBD_KEY_UNKNOWN,
  [BTN_Y] = KBD_KEY_UNKNOWN,
  [BTN_Z] = KBD_KEY_UNKNOWN,
  [BTN_TL] = KBD_KEY_UNKNOWN,
  [BTN_TR] = KBD_KEY_UNKNOWN,
  [BTN_TL2] = KBD_KEY_UNKNOWN,
  [BTN_TR2] = KBD_KEY_UNKNOWN,
  [BTN_SELECT] = KBD_KEY_UNKNOWN,
  [BTN_START] = KBD_KEY_UNKNOWN,
  [BTN_MODE] = KBD_KEY_UNKNOWN,
  [BTN_THUMBL] = KBD_KEY_UNKNOWN,
  [BTN_THUMBR] = KBD_KEY_UNKNOWN,
  [BTN_DIGI] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_PEN] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_RUBBER] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_BRUSH] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_PENCIL] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_AIRBRUSH] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_FINGER] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_MOUSE] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_LENS] = KBD_KEY_UNKNOWN,
  [BTN_TOUCH] = KBD_KEY_UNKNOWN,
  [BTN_STYLUS] = KBD_KEY_UNKNOWN,
  [BTN_STYLUS2] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_DOUBLETAP] = KBD_KEY_UNKNOWN,
  [BTN_TOOL_TRIPLETAP] = KBD_KEY_UNKNOWN,
  [BTN_WHEEL] = KBD_KEY_UNKNOWN,
  [BTN_GEAR_DOWN] = KBD_KEY_UNKNOWN,
  [BTN_GEAR_UP] = KBD_KEY_UNKNOWN,
  [KEY_OK] = KBD_KEY_UNKNOWN,
  [KEY_SELECT] = KBD_KEY_FUNCTION(Select),
  [KEY_GOTO] = KBD_KEY_UNKNOWN,
  [KEY_CLEAR] = KBD_KEY_FUNCTION(Clear),
  [KEY_POWER2] = KBD_KEY_UNKNOWN,
  [KEY_OPTION] = KBD_KEY_UNKNOWN,
  [KEY_INFO] = KBD_KEY_UNKNOWN,
  [KEY_TIME] = KBD_KEY_UNKNOWN,
  [KEY_VENDOR] = KBD_KEY_UNKNOWN,
  [KEY_ARCHIVE] = KBD_KEY_UNKNOWN,
  [KEY_PROGRAM] = KBD_KEY_UNKNOWN,
  [KEY_CHANNEL] = KBD_KEY_UNKNOWN,
  [KEY_FAVORITES] = KBD_KEY_UNKNOWN,
  [KEY_EPG] = KBD_KEY_UNKNOWN,
  [KEY_PVR] = KBD_KEY_UNKNOWN,
  [KEY_MHP] = KBD_KEY_UNKNOWN,
  [KEY_LANGUAGE] = KBD_KEY_UNKNOWN,
  [KEY_TITLE] = KBD_KEY_UNKNOWN,
  [KEY_SUBTITLE] = KBD_KEY_UNKNOWN,
  [KEY_ANGLE] = KBD_KEY_UNKNOWN,
  [KEY_ZOOM] = KBD_KEY_UNKNOWN,
  [KEY_MODE] = KBD_KEY_UNKNOWN,
  [KEY_KEYBOARD] = KBD_KEY_UNKNOWN,
  [KEY_SCREEN] = KBD_KEY_UNKNOWN,
  [KEY_PC] = KBD_KEY_UNKNOWN,
  [KEY_TV] = KBD_KEY_UNKNOWN,
  [KEY_TV2] = KBD_KEY_UNKNOWN,
  [KEY_VCR] = KBD_KEY_UNKNOWN,
  [KEY_VCR2] = KBD_KEY_UNKNOWN,
  [KEY_SAT] = KBD_KEY_UNKNOWN,
  [KEY_SAT2] = KBD_KEY_UNKNOWN,
  [KEY_CD] = KBD_KEY_UNKNOWN,
  [KEY_TAPE] = KBD_KEY_UNKNOWN,
  [KEY_RADIO] = KBD_KEY_UNKNOWN,
  [KEY_TUNER] = KBD_KEY_UNKNOWN,
  [KEY_PLAYER] = KBD_KEY_UNKNOWN,
  [KEY_TEXT] = KBD_KEY_UNKNOWN,
  [KEY_DVD] = KBD_KEY_UNKNOWN,
  [KEY_AUX] = KBD_KEY_UNKNOWN,
  [KEY_MP3] = KBD_KEY_UNKNOWN,
  [KEY_AUDIO] = KBD_KEY_UNKNOWN,
  [KEY_VIDEO] = KBD_KEY_UNKNOWN,
  [KEY_DIRECTORY] = KBD_KEY_UNKNOWN,
  [KEY_LIST] = KBD_KEY_UNKNOWN,
  [KEY_MEMO] = KBD_KEY_UNKNOWN,
  [KEY_CALENDAR] = KBD_KEY_UNKNOWN,
  [KEY_RED] = KBD_KEY_UNKNOWN,
  [KEY_GREEN] = KBD_KEY_UNKNOWN,
  [KEY_YELLOW] = KBD_KEY_UNKNOWN,
  [KEY_BLUE] = KBD_KEY_UNKNOWN,
  [KEY_CHANNELUP] = KBD_KEY_UNKNOWN,
  [KEY_CHANNELDOWN] = KBD_KEY_UNKNOWN,
  [KEY_FIRST] = KBD_KEY_UNKNOWN,
  [KEY_LAST] = KBD_KEY_UNKNOWN,
  [KEY_AB] = KBD_KEY_UNKNOWN,
  [KEY_NEXT] = KBD_KEY_UNKNOWN,
  [KEY_RESTART] = KBD_KEY_UNKNOWN,
  [KEY_SLOW] = KBD_KEY_UNKNOWN,
  [KEY_SHUFFLE] = KBD_KEY_UNKNOWN,
  [KEY_BREAK] = KBD_KEY_UNKNOWN,
  [KEY_PREVIOUS] = KBD_KEY_UNKNOWN,
  [KEY_DIGITS] = KBD_KEY_UNKNOWN,
  [KEY_TEEN] = KBD_KEY_UNKNOWN,
  [KEY_TWEN] = KBD_KEY_UNKNOWN,
  [KEY_VIDEOPHONE] = KBD_KEY_UNKNOWN,
  [KEY_GAMES] = KBD_KEY_UNKNOWN,
  [KEY_ZOOMIN] = KBD_KEY_UNKNOWN,
  [KEY_ZOOMOUT] = KBD_KEY_UNKNOWN,
  [KEY_ZOOMRESET] = KBD_KEY_UNKNOWN,
  [KEY_WORDPROCESSOR] = KBD_KEY_UNKNOWN,
  [KEY_EDITOR] = KBD_KEY_UNKNOWN,
  [KEY_SPREADSHEET] = KBD_KEY_UNKNOWN,
  [KEY_GRAPHICSEDITOR] = KBD_KEY_UNKNOWN,
  [KEY_PRESENTATION] = KBD_KEY_UNKNOWN,
  [KEY_DATABASE] = KBD_KEY_UNKNOWN,
  [KEY_NEWS] = KBD_KEY_UNKNOWN,
  [KEY_VOICEMAIL] = KBD_KEY_UNKNOWN,
  [KEY_ADDRESSBOOK] = KBD_KEY_UNKNOWN,
  [KEY_MESSENGER] = KBD_KEY_UNKNOWN,
  [KEY_DISPLAYTOGGLE] = KBD_KEY_UNKNOWN,
  [KEY_SPELLCHECK] = KBD_KEY_UNKNOWN,
  [KEY_LOGOFF] = KBD_KEY_UNKNOWN,
  [KEY_DOLLAR] = KBD_KEY_UNKNOWN,
  [KEY_EURO] = KBD_KEY_UNKNOWN,
  [KEY_FRAMEBACK] = KBD_KEY_UNKNOWN,
  [KEY_FRAMEFORWARD] = KBD_KEY_UNKNOWN,
  [KEY_CONTEXT_MENU] = KBD_KEY_UNKNOWN,
  [KEY_MEDIA_REPEAT] = KBD_KEY_UNKNOWN,
  [KEY_DEL_EOL] = KBD_KEY_UNKNOWN,
  [KEY_DEL_EOS] = KBD_KEY_UNKNOWN,
  [KEY_INS_LINE] = KBD_KEY_UNKNOWN,
  [KEY_DEL_LINE] = KBD_KEY_UNKNOWN,
  [KEY_FN] = KBD_KEY_UNKNOWN,
  [KEY_FN_ESC] = KBD_KEY_UNKNOWN,
  [KEY_FN_F1] = KBD_KEY_UNKNOWN,
  [KEY_FN_F2] = KBD_KEY_UNKNOWN,
  [KEY_FN_F3] = KBD_KEY_UNKNOWN,
  [KEY_FN_F4] = KBD_KEY_UNKNOWN,
  [KEY_FN_F5] = KBD_KEY_UNKNOWN,
  [KEY_FN_F6] = KBD_KEY_UNKNOWN,
  [KEY_FN_F7] = KBD_KEY_UNKNOWN,
  [KEY_FN_F8] = KBD_KEY_UNKNOWN,
  [KEY_FN_F9] = KBD_KEY_UNKNOWN,
  [KEY_FN_F10] = KBD_KEY_UNKNOWN,
  [KEY_FN_F11] = KBD_KEY_UNKNOWN,
  [KEY_FN_F12] = KBD_KEY_UNKNOWN,
  [KEY_FN_1] = KBD_KEY_UNKNOWN,
  [KEY_FN_2] = KBD_KEY_UNKNOWN,
  [KEY_FN_D] = KBD_KEY_UNKNOWN,
  [KEY_FN_E] = KBD_KEY_UNKNOWN,
  [KEY_FN_F] = KBD_KEY_UNKNOWN,
  [KEY_FN_S] = KBD_KEY_UNKNOWN,
  [KEY_FN_B] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT1] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT2] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT3] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT4] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT5] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT6] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT7] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT8] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT9] = KBD_KEY_UNKNOWN,
  [KEY_BRL_DOT10] = KBD_KEY_UNKNOWN,
  [KEY_MIN_INTERESTING] = KBD_KEY_UNKNOWN,
END_KEY_CODE_MAP
