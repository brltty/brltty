...
const HSVColorEntry hsvColorTable[] = {
  ...
  { .name = "Light Pink",
    .hue = {.minimum=330.0f, .maximum=345.0f},
    .saturation = {.minimum=0.20f, .maximum=0.35f},
    .value = {.minimum=0.85f, .maximum=1.00f},
  },

  { .name = "Pink",
    .hue = {.minimum=320.0f, .maximum=330.0f},
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },
  ...
  { .name = "Coral",
    ...
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.85f, .maximum=0.95f},
  },

  { .name = "Lime",
    .hue = {.minimum=75.0f, .maximum=85.0f},
    .saturation = {.minimum=0.80f, .maximum=1.00f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },

  { .name = "Dark Teal",
    .hue = {.minimum=170.0f, .maximum=200.0f},
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.30f, .maximum=0.50f},
  },

  { .name = "Teal",
    .hue = {.minimum=170.0f, .maximum=190.0f},
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.50f, .maximum=0.70f},
  },

  { .name = "Turquoise",
    .hue = {.minimum=160.0f, .maximum=170.0f},
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.70f, .maximum=0.90f},
  },
  ...
  { .name = "Indigo",
    .hue = {.minimum=230.0f, .maximum=250.0f},
    .saturation = {.minimum=0.50f, .maximum=0.70f},
    .value = {.minimum=0.30f, .maximum=0.50f},
  },
  ...
  { .name = "Gold",
    ...
    .saturation = {.minimum=0.70f, .maximum=0.90f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },
  ...
  { .name = "Cream",
    .hue = {.minimum=55.0f, .maximum=65.0f},
    .saturation = {.minimum=0.20f, .maximum=0.30f},
  ...
  { .name = "Alabaster",
    .hue = {.minimum=0.0f, .maximum=30.0f},
    .saturation = {.minimum=0.05f, .maximum=0.10f},
    .value = {.minimum=0.95f, .maximum=1.00f},
  },

  { .name = "Vanilla",
    .hue = {.minimum=50.0f, .maximum=55.0f},
    .saturation = {.minimum=0.10f, .maximum=0.20f},
    .value = {.minimum=0.95f, .maximum=1.00f},
  },

  { .name = "Chartreuse",
    .hue = {.minimum=85.0f, .maximum=95.0f},
    .saturation = {.minimum=0.70f, .maximum=0.90f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },
  ...
  { .name = "Mint",
    .hue = {.minimum=150.0f, .maximum=170.0f},
  ...
  { .name = "Periwinkle",
    .hue = {.minimum=220.0f, .maximum=240.0f},
    .saturation = {.minimum=0.20f, .maximum=0.40f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },
  ...
  { .name = "Aqua",
    .hue = {.minimum=180.0f, .maximum=190.0f},
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },

  { .name = "Fuchsia",
    .hue = {.minimum=300.0f, .maximum=320.0f},
    .saturation = {.minimum=0.70f, .maximum=0.90f},
    .value = {.minimum=0.70f, .maximum=0.90f},
  },
  ...
  { .name = "Plum",
    .hue = {.minimum=290.0f, .maximum=310.0f},
    .saturation = {.minimum=0.30f, .maximum=0.50f},
    .value = {.minimum=0.40f, .maximum=0.60f},
  },
  ...
  { .name = "Aquamarine",
    .hue = {.minimum=170.0f, .maximum=180.0f},
    .saturation = {.minimum=0.40f, .maximum=0.60f},
    .value = {.minimum=0.80f, .maximum=1.00f},
  },

  { .name = "Emerald",
    .hue = {.minimum=140.0f, .maximum=160.0f},
    .saturation = {.minimum=0.60f, .maximum=0.80f},
    .value = {.minimum=0.60f, .maximum=0.80f},
  },
  ...
  { .name = "Terracotta",
    .hue = {.minimum=10.0f, .maximum=18.0f},
    .saturation = {.minimum=0.50f, .maximum=0.65f},
    .value = {.minimum=0.70f, .maximum=0.80f},
  },

  { .name = "Copper",
    .hue = {.minimum=25.0f, .maximum=30.0f},
    .saturation = {.minimum=0.60f, .maximum=0.80f},
    .value = {.minimum=0.70f, .maximum=0.85f},
  },
  ...
  { .name = "Rust",
    ...
    .saturation = {.minimum=0.60f, .maximum=0.80f},
    .value = {.minimum=0.60f, .maximum=0.75f},
  },

  { .name = "Blush",
    .hue = {.minimum=345.0f, .maximum=355.0f},
    .saturation = {.minimum=0.10f, .maximum=0.25f},
    .value = {.minimum=0.85f, .maximum=0.95f},
  },
