...
typedef enum {
  ...
  USB_CH341_LCR_PARITY_MARK_SPACE = 0X20,
  USB_CH341_LCR_PARITY_EVEN       = 0X10,
  USB_CH341_LCR_PARITY_ENABLE     = 0X08,
  USB_CH341_LCR_PARITY_MASK       = USB_CH341_LCR_PARITY_ENABLE | USB_CH341_LCR_PARITY_EVEN | USB_CH341_LCR_PARITY_MARK_SPACE,
  USB_CH341_LCR_PARITY_ODD        = 0X00,
  USB_CH341_LCR_PARITY_SPACE      = USB_CH341_LCR_PARITY_MARK_SPACE | USB_CH341_LCR_PARITY_EVEN,
  USB_CH341_LCR_PARITY_MARK       = USB_CH341_LCR_PARITY_MARK_SPACE,

  USB_CH341_LCR_STOP_BITS_1       = 0X00,
  USB_CH341_LCR_STOP_BITS_2       = 0X04,
  USB_CH341_LCR_STOP_BITS_MASK    = USB_CH341_LCR_STOP_BITS_1 | USB_CH341_LCR_STOP_BITS_2,
...
typedef enum {
  USB_CH341_PSF_DISABLE_8x  = 0X01,
  USB_CH341_PSF_DISABLE_64x = 0X02,
  USB_CH341_PSF_DISABLE_2x  = 0X04,
  USB_CH341_PSF_IMMEDIATE   = 0X80, // don't wait till there are 32 bytes
