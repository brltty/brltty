...
BEGIN_KEY_CODE_MAP
  ...
  [ANDROID_KEY_MEDIA_NEXT] = KBD_KEY_FUNCTION(SongNext),
  [ANDROID_KEY_MEDIA_PAUSE] = KBD_KEY_UNMAPPED,
  [ANDROID_KEY_MEDIA_PLAY] = KBD_KEY_UNMAPPED,
  [ANDROID_KEY_MEDIA_PLAY_PAUSE] = KBD_KEY_FUNCTION(PlayPause),
  [ANDROID_KEY_MEDIA_PREVIOUS] = KBD_KEY_FUNCTION(SongPrevious),
