...
BEGIN_KEY_NAME_TABLE(keyboard)
  ...
  KBD_NAME_ENTRY(BRAILLE, Space, "Dot0"),
  KBD_NAME_ENTRY(BRAILLE, Space, "BRAILLE_Dot0"),
  ...
  KEY_GROUP_ENTRY(KBD_GRP_NUMBER, "NumberKey"),
  KEY_GROUP_ENTRY(KBD_GRP_FUNCTION, "FunctionKey"),
  KEY_GROUP_ENTRY(KBD_GRP_KPNUMBER, "KeypadNumberKey"),
  KEY_GROUP_ENTRY(KBD_GRP_ROUTING, "RoutingKey"),
END_KEY_NAME_TABLE
