...
#ifdef HAVE_LINUX_INPUT_H
LINUX_KEY_TABLE(linuxKeyTable_xt00) = {
...
LINUX_KEY_TABLE(linuxKeyTable_xtE0) = {
...
LINUX_KEY_TABLE(linuxKeyTable_at00) = {
...
LINUX_KEY_TABLE(linuxKeyTable_atE0) = {
...
LINUX_KEY_TABLE(linuxKeyTable_atE1) = {
  [AT_KEY_E1_Pause] = KEY_PAUSE,
};

LINUX_KEY_TABLE(linuxKeyTable_ps2) = {
...
LINUX_KEY_TABLE(linuxKeyTable_hid) = {
