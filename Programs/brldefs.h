...
typedef enum {
  ...
  BRL_CMD_SAY_PREV_CHAR /* go to and speak previous character */,
  BRL_CMD_SAY_NEXT_CHAR /* go to and speak next character */,
  BRL_CMD_SAY_CURR_WORD /* speak current word */,
  BRL_CMD_SAY_PREV_WORD /* go to and speak previous word */,
  BRL_CMD_SAY_NEXT_WORD /* go to and speak next word */,
