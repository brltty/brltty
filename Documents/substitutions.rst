.. |README.Android| replace:: `Using BRLTTY on Android`_
...
.. |README.DOS| replace:: `Using BRLTTY on DOS`_
.. |README.KeyTables| replace:: `Key Tables`_
.. |README.OpenBSD| replace:: `Using BRLTTY on OpenBSD`_
...
.. |README.Windows| replace:: `Using BRLTTY on Windows`_
