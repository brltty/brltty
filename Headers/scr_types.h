...
#define SCR_MASK_FG (SCR_ATTR_FG_RED | SCR_ATTR_FG_GREEN | SCR_ATTR_FG_BLUE | SCR_ATTR_FG_BRIGHT)
#define SCR_MASK_BG (SCR_ATTR_BG_RED | SCR_ATTR_BG_GREEN | SCR_ATTR_BG_BLUE)

#define SCR_COLOUR_FG_BLACK      0
#define SCR_COLOUR_FG_BLUE       (SCR_ATTR_FG_BLUE)
#define SCR_COLOUR_FG_GREEN      (SCR_ATTR_FG_GREEN)
#define SCR_COLOUR_FG_CYAN       (SCR_ATTR_FG_GREEN | SCR_ATTR_FG_BLUE)
#define SCR_COLOUR_FG_RED        (SCR_ATTR_FG_RED)
#define SCR_COLOUR_FG_MAGENTA    (SCR_ATTR_FG_RED | SCR_ATTR_FG_BLUE)
#define SCR_COLOUR_FG_BROWN      (SCR_ATTR_FG_RED | SCR_ATTR_FG_GREEN)
#define SCR_COLOUR_FG_LIGHT_GREY (SCR_ATTR_FG_RED | SCR_ATTR_FG_GREEN | SCR_ATTR_FG_BLUE)
#define SCR_COLOUR_FG_DARK_GREY      (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_BLACK)
#define SCR_COLOUR_FG_LIGHT_BLUE     (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_BLUE)
#define SCR_COLOUR_FG_LIGHT_GREEN    (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_GREEN)
#define SCR_COLOUR_FG_LIGHT_CYAN     (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_CYAN)
#define SCR_COLOUR_FG_LIGHT_RED      (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_RED)
#define SCR_COLOUR_FG_LIGHT_MAGENTA  (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_MAGENTA)
#define SCR_COLOUR_FG_YELLOW         (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_BROWN)
#define SCR_COLOUR_FG_WHITE          (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_LIGHT_GREY)

#define SCR_COLOUR_BG_BLACK      0
#define SCR_COLOUR_BG_BLUE       (SCR_ATTR_BG_BLUE)
#define SCR_COLOUR_BG_GREEN      (SCR_ATTR_BG_GREEN)
#define SCR_COLOUR_BG_CYAN       (SCR_ATTR_BG_GREEN | SCR_ATTR_BG_BLUE)
#define SCR_COLOUR_BG_RED        (SCR_ATTR_BG_RED)
#define SCR_COLOUR_BG_MAGENTA    (SCR_ATTR_BG_RED | SCR_ATTR_BG_BLUE)
#define SCR_COLOUR_BG_BROWN      (SCR_ATTR_BG_RED | SCR_ATTR_BG_GREEN)
#define SCR_COLOUR_BG_LIGHT_GREY (SCR_ATTR_BG_RED | SCR_ATTR_BG_GREEN | SCR_ATTR_BG_BLUE)
