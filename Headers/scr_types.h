...
#define SCR_COLOUR_FG_LIGHT__BLUE    (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_BLUE)
#define SCR_COLOUR_FG_LIGHT__GREEN   (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_GREEN)
#define SCR_COLOUR_FG_LIGHT__CYAN    (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_CYAN)
#define SCR_COLOUR_FG_LIGHT__RED     (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_RED)
#define SCR_COLOUR_FG_LIGHT__MAGENTA (SCR_ATTR_FG_BRIGHT | SCR_COLOUR_FG_MAGENTA)
