...
typedef enum {
  ...
  BRL_CMD_PASTE_BRACKETED /* insert bracketed clipboard text after screen cursor */,
...
typedef enum {
  ...
  BRL_BLK_PASTE_HISTORY_BRACKETED /* insert bracketed clipboard history entry after screen cursor */,
