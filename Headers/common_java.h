...
#define JAVA_SIG_OUT_OF_MEMORY_ERROR JAVA_SIG_OBJECT(OJAVA_OBJ_OUT_OF_MEMORY_ERROR)
...
#define JAVA_SIG_UNSATISFIED_LINK_ERROR JAVA_SIG_OBJECT(OJAVA_OBJ_UNSATISFIED_LINK_ERROR)
